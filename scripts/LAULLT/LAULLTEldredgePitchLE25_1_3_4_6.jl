...
let
    ...
    run_laullt_cfd_comp(
        wing, kinematics,
        cfd_path*"eldredge_pitchLE25_Re10k_1_3_4_6_RectAr3.dat";
        cfd_res_path2d=cfd_path*"eldredge_pitchLE25_Re10k_1_3_4_6_RectArInf.dat",
        cfd_res_toff=250
    )
end
