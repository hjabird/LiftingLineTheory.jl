...
let
	...
	println("Ampitude is 45 degrees. t1=1s, t2=3s, t3=4s, t4=6s, tmax=7s")
    ...
    for i = 1 : nsteps
        print("\rLAULLT step ", i, " of ", nsteps, ".\t\t\t\t\t")
    ...
    cfd_results = readdlm("scripts/CFD_results_ref/eldredge_pitchLE45_Re10k_1_3_4_6.dat",',';header=true) 
